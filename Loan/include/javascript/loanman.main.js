    ...
    return {
        ...
        initialiseMain: function () {
            $("#Content").load("/html/client.aspx", function () {
                ...
                //    SaveUser();
                //})
                //loanman.client.initialiseMain();
            })
            $("#liNewClient").bind("click", function () {
                $("#Content").load("/html/client.aspx", function () {
                    //$("#txtDateOfBirth").datepicker();
            ...
            $("#liEditClient").bind("click", function () {
                $("#Content").load("/html/clientlist.aspx", function () {

                })
            })

            $("#liLoan").bind("click", function () {
                $("#Content").load("/html/loan.aspx", function () {
